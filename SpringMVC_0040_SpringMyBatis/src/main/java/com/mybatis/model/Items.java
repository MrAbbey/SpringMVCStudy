...
import com.mybatis.validation.MyGroup2;
...
public class Items {
     ...
     * @mbggenerated Tue Sep 22 13:38:45 CST 2015
     */
    @Size(min = 1,max = 30,message = "{items.name.length.error}",groups = {MyGroup1.class})
    private String name;
     ...
     * @mbggenerated Tue Sep 22 13:38:45 CST 2015
     */
    @NotNull(message = "{items.price.null}",groups = {MyGroup2.class})
    private Float price;
